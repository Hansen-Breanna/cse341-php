...
<body class="bg-dark h-100 m-0">
    <header>
        <nav class="navbar navbar-expand-sm bg-info navbar-toggleable-sm navbar-dark text-ldark border-bottom box-shadow mb-3">
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse d-sm-inline-flex flex-sm-row-reverse">
                    <ul class="navbar-nav flex-grow-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-light" asp-area="" asp-page="/Scriptures/About">About</a>
                        </li>
                        <li class="nav-item">
