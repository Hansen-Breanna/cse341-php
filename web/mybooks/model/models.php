...
function displayCatalog($catalog) {
    ...
    foreach ($catalog as $book) {
       ...
       $bookList .= '<td class="pl-5"><a href="" title="Edit"><i class="icon mr-1 rounded far fa-edit bg-info p-2" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>';
       $bookList .= '<a href="" title="Delete"><i class="icon rounded far fa-trash-alt bg-danger p-2" data-toggle="tooltip" data-placement="top" title="Delete"></i></a></td>';
       $bookList .= '</tr>';
    }
    $bookList .= '</tbody>';
    return $bookList;
