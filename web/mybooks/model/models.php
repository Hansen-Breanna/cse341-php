...
function displayLoans($loans) {
    ...
    foreach ($loans as $loan) {
       ...
       $loanList .= '<td class="d-flex flex-column flex-sm-row flex-sm-wrap"><a class="rounded p-1 bg-orange mr-1" href="sms://+1';
       ...
       $loanList .= '<form method="post" action="index.php?action=authors">
