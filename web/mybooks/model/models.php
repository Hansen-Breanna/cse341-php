...
function displayCatalog($catalog) {
    ...
    foreach ($catalog as $book) {
       ...
       $bookList .= '<td class="pl-5><a href="" title="Edit"><i class="rounded far fa-edit bg-danger p-2" data-toggle="tooltip" data-placement="top" title="Edit"></i></a><a href="" title="Edit"><i class="rounded far fa-edit bg-info p-2 mr-1" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>';
