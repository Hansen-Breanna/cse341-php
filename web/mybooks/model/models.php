...
function displayLoans($loans)
{
   ...
   foreach ($loans as $loan) {
      ...
      $loanList .= '<td class="d-flex flex-column flex-sm-row flex-sm-wrap"><a class="btn bg-orange mr-1 mb-1 btn-100" href="sms://+1';
      ...
      $loanList .= '<form method="post" action="index.php?action=update-loan">
         ...
         <input type="submit" class="bg-info btn-100 btn mr-1 mb-1" value="Edit"/>
       </form>
       <form method="post" action="index.php?action=loans">
         <input type="hidden" name="delete" value="' . $loan['id'] . '"/>
         <input type="submit" class="bg-danger btn-100 btn mr-1 mb-1" value="Return"/>
      </form>
      </td></tr>';
   }
   $loanList .= '</tbody>';
