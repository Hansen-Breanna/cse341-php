...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (isset($_POST['delete'])) {
    ...
    $authorID = test_input($_POST['update_author']);
    try {
    ...
    <div class="row d-flex flex-column align-items-center">
      <div>
        ...
        <form method="post" action="index.php?action=get-author">
          ...
          <a href="index.php?action=authors" title="See All Authors" class="btn btn-custom my-2 ml-2 ml-3 bg-info">See All Authors</a>
      </div>
      <div>
        <?php
        echo $message;
